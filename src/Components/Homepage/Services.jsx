            ...
            <div className="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s" >
              <div className='card' style={{ backgroundColor: '#ff3e41' }}>
                <div className='card-body'>
                  <h3>Dry Van</h3>
                  <p>If you are looking for a truck dispatcher to manage your dry van freight, you’ve found the right truck dispatching company that can help you achieve a peace of mind through professional truck dispatching services. Reach out today. </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s" >
              <div className='card' style={{ backgroundColor: '#ff3e41' }}>
                <div className='card-body'>
                  ...
                  <img src="img/dr.png" className='mt-3 mb-3 ms-5' alt="" />
                  <p className='text-white'>If you are looking for a truck dispatcher to manage your dry van freight, you’ve found the right truck dispatching company that can help you achieve a peace of mind through professional truck dispatching services. Reach out today. </p>
                </div>
              </div>
            </div>
